...
<div class="btn-group d-flex border-bottom border-3 border-dark rounded-0" role="group" aria-label="Basic example">
  <button type="button" class="btn btn-dark rounded-0 flex-fill" style="background-color:#4b3d17" disabled>Generate LHE</button>
  <a class="btn btn-dark border-0 rounded-0 flex-fill" style="background-color:#4b3d17" href="/lhe/kirimLHE" role="button">Kirim LHE</a>
  <a class="btn btn-dark border-0 rounded-0 flex-fill" style="background-color:#4b3d17" href="/lhe/feedbackLHE" role="button">Feedback LHE</a>
</div>
          ...
          <tr>
            ...
            <td>
              <button class="badge bg-primary border-0">
                <span data-feather="download"></span> Unduh
              </button>
            </td>
          </tr>
          @endforeach
