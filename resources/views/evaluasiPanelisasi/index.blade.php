...
<div class="container mt-3">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb border-bottom border-dark">
        <li class="breadcrumb-item active" style="color:black;" aria-current="page"><h4>Panelisasi</h4></li>
    </ol>
  </nav>
</div>
  ...
  <div class="border-bottom border-1 border-dark mb-3">
    ...
    <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
      ...
      <div class="input-group">
        <form action="/evaluasiPanelisasi">
        ...
        <tbody>
          ...
          @if ($unitKerjas->count())
            ...
            <tr>
              ...
              <td>
                <form action="/evaluasiPanelisasi/{{ $unitKerja->id }}" class="d-inline">
                  @csrf
                  <input type="hidden" class="form-control" name="page" id="page" value="LKETL" required>
