...
<div class="container mt-3">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb border-bottom border-dark">
      ...
      <li class="breadcrumb active mt-1" aria-current="page"><h5 class="d-inline" style="text-decoration:none; color:black">&nbsp/ Hasil DE dan Monev TL</h5></li>
    </ol>
  </nav>
</div>
  ...
  <div class="border-bottom border-1 border-dark mb-3">
    ...
    <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
      ...
      <div class="input-group">
        <form action="/dashboard/hasilDEdanMonevTL">
            ...
            <tr>
              ...
              <td>
                ...
                @endphp
                  {{ $namaProvinsi }}</td>
              <td>
                <a href="/dashboard/hasilDEdanMonevTL/hasilDE/{{ $provinsi->id }}" class="badge bg-info"><span data-feather="eye"></span></a>
              </td>
            </tr>
            @endforeach
        </tbody>
