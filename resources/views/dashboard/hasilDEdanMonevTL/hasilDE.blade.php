...
<div class="btn-group d-flex border-bottom border-dark rounded-0" role="group" aria-label="Basic example">
  <button type="button" class="btn btn-dark rounded-0 flex-fill" style="background-color:#4b3d17" disabled>Hasil Desk Evaluation</button>
  <a class="btn btn-dark rounded-0 flex-fill" style="background-color:#4b3d17" href="/dashboard/hasilDEdanMonevTL/monevTL/{{ $provinsi->id }}" role="button">Monev Tindak Lanjut</a>
</div>
