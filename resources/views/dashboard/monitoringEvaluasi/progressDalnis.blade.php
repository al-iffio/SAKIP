...
<div class="btn-group d-flex border-bottom border-dark rounded-0" role="group" aria-label="Basic example">
  <a class="btn btn-dark rounded-0 flex-fill" style="background-color:#4b3d17" href="/dashboard/monitoringEvaluasi/progressAT" role="button">Progress Anggota Tim</a>
  <a class="btn btn-dark rounded-0 flex-fill" style="background-color:#4b3d17" href="/dashboard/monitoringEvaluasi/progressKT" role="button">Progress Ketua Tim</a>
  <button type="button" class="btn btn-secondary rounded-0 flex-fill" style="background-color:#4b3d17" disabled>Progress Pengendali Teknis</button>
</div>

<div class="bg-white p-3 mb-3">
  <div id="progressDalnis"></div>
</div>
...
<script>
  Highcharts.chart('progressDalnis', {
      chart: {
          type: 'bar',
          height: '100%'
      },
      title: {
          text: 'Progress Evaluasi Pengendali Teknis'
      },
      xAxis: {
          title: {
      ...
      yAxis: {
          min: 0,
          title: {
              text: 'Progress Pengendali Teknis (%)'
          }
      },
      plotOptions: {
          series: {
