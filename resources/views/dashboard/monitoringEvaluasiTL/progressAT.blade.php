...
<div class="btn-group d-flex border-bottom border-3 border-dark rounded-0" role="group" aria-label="Basic example">
  ...
  <a class="btn btn-dark border-0 rounded-0 flex-fill" style="background-color:#4b3d17" href="/dashboard/monitoringEvaluasiTL/progressKT" role="button">Progress Ketua Tim</a>
  <a class="btn btn-dark border-0 rounded-0 flex-fill" style="background-color:#4b3d17" href="/dashboard/monitoringEvaluasiTL/progressDalnis" role="button">Progress Pengendali Teknis</a>
</div>
