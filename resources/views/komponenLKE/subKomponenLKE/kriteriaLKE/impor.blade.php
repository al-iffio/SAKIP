      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-center">
            <form action="/komponenLKE/subKomponenLKE/kriteriaLKE/downloadTemplate" method="post">
              @csrf
          ...
          <form action="/komponenLKE/subKomponenLKE/kriteriaLKE/import" method="post" enctype="multipart/form-data">
            @csrf
              ...
              <div class="my-3">
                <input class="form-control @error('kriteriaLKE') is-invalid @enderror" type="file" id="kriteriaLKE" name="kriteriaLKE"
                accept=".xlsx,.xls">
                @if ($errors->any())
