    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content bg-body-tertiary">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Dokumen Pelatihan</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="/repository/pelatihan/create">
            @csrf
            <div class="mb-3 row">
              <label for="jumlahInput" class="col-form-label">Jumlah dokumen pelatihan yang ingin ditambahkan</label>
