...
<div class="container mt-3">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb border-bottom border-dark">
      <li class="breadcrumb-item"><a href="/evaluasi_LKETL" style="text-decoration:none; color:black"><h4>Evaluasi LKE TL</h4></a></li>
  ...
  @foreach($komponenLKEs as $komponenLKE)
    <div class="col-sm-3 mb-3 mb-sm-0 py-2">
      <div class="card">
        ...
        onclick="return confirm('Tampilan LKE TL sama dengan tampilan pada menu LKE')">
          <div class="card-body">
