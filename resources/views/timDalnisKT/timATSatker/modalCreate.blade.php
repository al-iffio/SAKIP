<!-- Modal Tambah Tim -->
<div class="modal fade" id="tambahATSatker" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content bg-body-tertiary">
        ...
        <div class="modal-body">
          <form action="/timDalnisKT/timATSatker/create">
            @csrf
            <div class="mb-3 row">
              <input type="hidden" class="form-control" name="id" id="id" value="{{ $timDalnisKT->id }}" required>
